/********************************************************************************
* 		 	Shows 780_Diferent Fonts  On the MAX7219 8x8 Led Matrix		    	*
********************************************************************************/
...
void Systick_Loop(void){		
	...
	for(i = 0; i < 8; i++) { send_spi_data_16(i+1, font[counter][i]); }		// Sends Font(780) To MAX7219	
	counter++; if( counter > 780 ) { counter = 0; }							// Incrementes counter And Caps It
