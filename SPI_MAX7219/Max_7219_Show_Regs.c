/********************************************************************************
* 		 Shows a Registers_Variable On the MAX7219 8x8 Led Matrix		    	*
********************************************************************************/
...
uint8_t v[8] = {0,0,0,0,0,0,0,0};			// Var Used For Holding Registers Alike
int i,j;
...
void Systick_Loop(void){		
	...
	v[0]=counter; v[1]=0x55; v[3]=0xFF; v[4]=0xFF;							// Put Some Values In Regs
	v[6]=counter & 0x0F; v[7]=counter & 0xF0; 
	for(i = 0; i < 8; i++) { send_spi_data_16(i+1, v[i]); }					//Show Regs On MAX7219	
	counter++; 
	}
}
...
void Hardware_Init(void){
	...
	MAX7219_Init();															// Initializes 	MAX7219	8x8 Led Matrix
}
